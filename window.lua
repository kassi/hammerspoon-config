...
hs.hotkey.bind({"shift", "ctrl", "alt", "cmd"}, '1', function() MoveWindowToSpace(1) end)
hs.hotkey.bind({"shift", "ctrl", "alt", "cmd"}, '2', function() MoveWindowToSpace(2) end)
hs.hotkey.bind({"shift", "ctrl", "alt", "cmd"}, '3', function() MoveWindowToSpace(3) end)
...
function activateApplicationWindow(appname, title)
...
hs.hotkey.bind({"ctrl", "alt", "cmd"}, ",", placeWindow(0, 0, 0.70, 1))
hs.hotkey.bind({"ctrl", "alt", "cmd"}, ".", placeWindow(0.7, 0, 0.30, 1))
